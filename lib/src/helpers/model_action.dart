...
class ModelAction {
  ...
  Future<void> Function()? _successAction;
  ...
  ModelAction addSuccess(Future<void> Function() action) {
  ...
  Future<void> execute() async {
    if (_insertAction != null) {
      ...
      await helper.insertLastId(_insertLastIdAction!, success: _successAction);
    } else if (_updateAction != null) {
      await helper.update(_updateAction!, success: _successAction);
    } else if (_deleteAction != null) {
      await helper.delete(_deleteAction!, success: _successAction);
    }
  }
}
